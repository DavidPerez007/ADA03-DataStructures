...
public class Testing {
    public static void main(String[] args) {
        ...
        Student joselito = new Student("joselito", "joselito");
        ...
        Student pepe = new Student("pepe", "pepe");
        ...
        Student jesulin = new Student("jesulin", "jesulin");
        ...
        System.out.println("removing pepe" + students.remove(pepe));
        System.out.println("test1");
        for (Student student : students) {
            System.out.println(student.getName() + "-" + student.getAvg());
        }
